...
export default class Pokemon extends GameEntity {
	...
	/**
 * Load moves for this Pokemon from move names and moves data
 * @param {Array<string>} moveNames - Array of move names from pokemon.json
 * @param {Object} movesData - The moves.json data object
 */
loadMoves(moveNames, movesData) {
    this.moves = [];
